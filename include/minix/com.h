...
#  define SYS_HMEM_MAP (KERNEL_CALL + 58)       /* sys_hmem_map() */

#define SYS_HARDENING (KERNEL_CALL + 59)      /* sys_hardening() */

#define SYS_ADDREGIONTOWS (KERNEL_CALL + 60)      /* sys_addregionto_ws() */

#define SYS_FREEPMBS (KERNEL_CALL + 61)      /* sys_free_pmbs() */
